...
import { CheckCircle2, Users, Map, FileText, Video, Award, School, Clock } from 'lucide-react'
  ...
  return (
    <section id="phases" className="py-20 bg-black relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {/* ATUALIZAÇÃO: Logo Oficial Adicionada */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Inscrição e Seleção</h3>
            </div>

            <ul className="space-y-4">
              <li className="flex items-start">
                <FileText className="w-5 h-5 text-cyan-400 mr-3 mt-1 flex-shrink-0" />
                <div>
                  <span className="block text-white font-bold text-lg">344</span>
                  <span className="text-gray-400 text-sm">Inscrições Recebidas</span>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <span className="text-gray-400 text-sm">Abrangência Inicial</span>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  <span className="block text-white font-bold text-lg">344</span>
                  <span className="text-gray-400 text-sm">Inscrições Homologadas</span>
                </div>
              </li>
              <li className="pt-2 border-t border-cyan-500/20 mt-2">
                 <span className="text-cyan-300 font-semibold">104 Pré-residentes Matriculados</span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Formação e Aplicação</h3>
            </div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
               ...
               <li className="flex items-start">
                ...
                <div>
                  <span className="block text-white font-bold text-lg">80 Residentes</span>
                  <span className="text-gray-400 text-sm">Concluintes (Baseado nos relatos)</span>
                </div>
              </li>
              <li className="pt-2 border-t border-pink-500/20 mt-2 flex items-center">
                 <Clock className="w-4 h-4 text-pink-400 mr-2" />
                 <span className="text-pink-300 font-semibold">+300 horas de formação em Bootcamps</span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Manna Champion Quantum</h3>
            </div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <span className="block text-white font-bold text-lg">1.356 Avaliações</span>
                  <span className="text-gray-400 text-sm">Realizadas por 12 avaliadores</span>
                </div>
              </li>
